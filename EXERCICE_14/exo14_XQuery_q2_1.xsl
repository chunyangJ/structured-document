  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <title>EXO14-XQUERY-Q2_1</title>
      </head>
      <body>
        <div class="header" align="center">
          <h1>Récapitulatif de la base<br/>ECRISCOL</h1>
          <h2>Nombre d’opérations de réécriture par type et par niveaux d’étude</h2>
        </div>
          ...
          <table class="alt">
            <tbody>
              <tr class="forme" style="text-align:center; font-weight: bold">
                <td width="20%">niveau</td>
                <td width="20%">remplacement</td>
                <td width="20%">insertion</td>
                <td width="20%">suppression</td>
                <td width="20%">correction</td>
              </tr>
